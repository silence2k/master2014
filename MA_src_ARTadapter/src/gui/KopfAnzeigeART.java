...
public class KopfAnzeigeART extends JPanel {
	...
	public KopfAnzeigeART(DataSource ds) {
		super();
		this.ds = ds;

		berechne = new Berechne(ds, true,false,true);
	}
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		final KopfAnzeigeART ta = new KopfAnzeigeART(data);
