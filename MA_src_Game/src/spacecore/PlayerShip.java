...
public class PlayerShip
{
    ...
    public void Update()
    {
        ...
        qRollen.setFromAxisAngle(new Vector4f(Forward.x, Forward.y, Forward.z, dRollen));
        Quaternion qNeigung = new Quaternion();
        qNeigung.setFromAxisAngle(new Vector4f(vRollen.x, vRollen.y, vRollen.z, -dNeigen));
