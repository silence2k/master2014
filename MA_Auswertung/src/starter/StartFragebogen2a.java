...
public class StartFragebogen2a {
...
//		
		JPanel p = new MyPanel1(new Stab1[]{
				...
				new Stab1("(2.2) Wie lange verwenden Sie einen Computer pro Woche?",names1b, werte6, new int[]{6,6,7,6,6,6,5,6,6,6,5,6,6}),
				new Stab1("(2.3) Haben Sie allgemeine Kenntnisse in Gestensteuerung?",names1c, werte4, new int[]{3,4,4,2,4,3,3,4,4,4,4,3,3}),
				new Stab1("(2.4) Haben Sie bereits Kenntnisse ¸ber 3D-Gestensteuerung?",names1d, werte4, new int[]{2,2,3,1,3,2,2,2,4,3,3,2,3})});
////				
//		JPanel p = new MyPanel1(new Stab1[]{
//				new Stab1("(2.5) Haben Sie bereits eine 3D-Gestensteuerung Verwendet?",names1e, werte4, new int[]{2,2,3,1,3,1,3,2,4,1,3,2,3}),
